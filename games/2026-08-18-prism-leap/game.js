window.GAME = {
  meta: {
    "title": "Prism Leap",
    "tagline": "Pure reflex.",
    "description": "Prism Leap — a prism / rainbow tap-to-flap through gaps game. Tap (or Space) to flap and thread every gap. Touch a wall or the floor and you're done.",
  ...
  create: function (engine) {
    var P = {"r":15,"grav":1500,"flap":-430,"vmax":620,"scroll":150,"ramp":6,"gap":190,"gapX":240,"wallW":58,"accent":"#7CFFCB","accent2":"#4ADEDE","hazard":"#ff5d73"};
