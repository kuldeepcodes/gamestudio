window.GAME = {
  meta: {
    "title": "Autumn Bounce",
    "tagline": "Pure reflex.",
    "description": "Autumn Bounce — a autumn forest endless brick-breaker game. Bounce the ball to shatter every brick. Clear a wave and a denser one drops. Miss the ball and it's over.",
  ...
  create: function (engine) {
    var P = {"pw":118,"pspeed":620,"pmargin":40,"br":9,"bspeed":318,"ramp":0.03,"cols":8,"rowsMax":6,"bh":20,"accent":"#f9a8d4","accent2":"#c084fc","hazard":"#ff5d73"};
